...
4. Desktop after — healthy; 20px/500 conditions form a secondary summary above the pyramid. Evidence: `14-after-desktop.png`.
...
6. Phones at 390px and 320px after — healthy; each stage remains readable, the pyramid begins within the first screen, and the header navigation fits without a scrollbar. Evidence: `16-after-mobile-390.png`, `17-after-mobile-320.png`.
