...
- Removed the duplicated scoring summary. Base hit values now sit in one compact strip, while each timing card contains its own recognition cue and ruling; the afterblow card carries the complete deduction rule and examples.
